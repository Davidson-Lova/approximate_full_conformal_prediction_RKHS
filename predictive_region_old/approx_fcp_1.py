...
class approx_fcp_1(cp):
    ...
    def _ncs_(self, X_train, Y_train, X_test, Z_test, params):
        ...
        for j in range(N_test):
            ...
            # Compute K matric
            mus += [smallest_non_zero_eig(self.predictor.K / self.predictor.K.shape[0])]
    ...
    # def predictor_qlty_bound(self, K_diag, mus, d_loss_Np1_y, d_loss_Np1_z, d_ncs):
    #     N_test = len(K_diag)
    ...
    # def monitor_ncs_bound(self, K_diag, mus, d_loss_Np1_y, d_loss_Np1_z, d_ncs):
    #     N_test = len(K_diag)
    #     N_train_p1 = K_diag[0].shape[0]
    ...
    def ncs_qlty_bound_0(self, K_diag, mus):
        N_test = len(K_diag)
        N_train_p1 = K_diag[0].shape[0]
    ...
    def ncs_qlty_bound(self, K_diag, mus, d_loss_Np1_y, d_loss_Np1_z, d_ncs):
        N_test = len(K_diag)
        N_train_p1 = K_diag[0].shape[0]
